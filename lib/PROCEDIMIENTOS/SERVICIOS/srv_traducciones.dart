...
class SrvTraducciones {
  ...
  static final Map<String, String> spanish = {
    ...
    'texto_alias':
        'Por favor, introduce el alias con el que quieres aparecer en la WFC (Competición Mundial Flippy)...',
    'alias': 'Alias',
    ...
    'pos_flippy': 'Tu ranking en la WFC:',
    'nivel': 'Nivel',
    'lento': '🐌 Lento',
    'normal': '🏃 Normal',
    'rapido': '🚀 Rápido',
  ...
  static final Map<String, String> catalan = {
    ...
    'texto_alias': "Si us plau, introdueix l'àlies amb el qual vols aparèixer a la WFC (Competició Mundial Flippy)...",
    'alias': 'Àlies',
    ...
    'pos_flippy': 'El teu ranking a la WFC',
    'nivel': 'Nivell',
    'lento': '🐌 Lent',
    'normal': '🏃 Normal',
    'rapido': '🚀 Ràpid',
